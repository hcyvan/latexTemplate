...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\Large Yihang Cheng}} \\
  Email: navycheng2020@gmail.com \\
  Mobile : (+86)188-1758-3485 \\
\end{tabular*}
...
\resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Doctor of Genetics;  GPA: ???}{Sep. 2011 -- Jun. 2019}
    \resumeSubheading
      {China Agricultural University}{Beijing, China}
      {Bachelor of Agriculture;  GPA: ???}{Sep. 2007 -- Jun. 2011}
